...
const analyzeContentPrompt = ai.definePrompt({
  ...
  prompt: `Analyze the following content for credibility, cross-referencing against multiple datasets and fact-checking APIs. Assign a credibility score (0-1) and provide a detailed explanation of your findings in {{language}}. It is crucial that you include verified alternatives and sources. Any URLs you provide in the explanation must be formatted as markdown links, for example: [Google](https://www.google.com).
